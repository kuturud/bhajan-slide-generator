...
![GitHub language count](https://img.shields.io/github/languages/count/kuturud/bhajan-generator)
...
This is a static web application that runs entirely in your browser. No build step or server-side processing required.

### Running Locally

1. **Clone the repository**:
   ```bash
   git clone https://github.com/kuturud/bhajan-generator.git
   cd bhajan-generator
   ```
...
> **Note**: You must use a local web server (not just opening `index.html` directly) because the app loads JSON data files via fetch/AJAX requests.
...
**Made with ❤️ for the Sai Bhajan community**
